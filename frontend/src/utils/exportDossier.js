...
export const exportToExcel = (caseData) => {
  ...
  const overviewData = [
    ...
    ['Risk Sub-Tier', risk.risk_sub_tier ? risk.risk_sub_tier.replace('_', ' ') : 'N/A'],
    ...
    ['PR/CR Cadence Policy', risk.pr_cr_trigger_rule || `${risk.recommended_review_cycle_months || 12} Months Cadence`],
